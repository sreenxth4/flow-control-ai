...
export const mockRoads = [
  { id: "R1", name: "Kukatpally Main Rd N", from_junction: "J1", to_junction: "J2", lanes: 3, speed_limit: 40, length_km: 0.9 },
  { id: "R2", name: "Kukatpally Main Rd S", from_junction: "J2", to_junction: "J1", lanes: 3, speed_limit: 40, length_km: 0.9 },
  { id: "R3", name: "Balanagar Rd E", from_junction: "J1", to_junction: "J3", lanes: 2, speed_limit: 30, length_km: 4.8 },
  { id: "R4", name: "Balanagar Rd W", from_junction: "J3", to_junction: "J1", lanes: 2, speed_limit: 30, length_km: 4.8 },
  { id: "R5", name: "JNTU Rd NW", from_junction: "J1", to_junction: "J4", lanes: 4, speed_limit: 50, length_km: 1.3 },
  { id: "R6", name: "JNTU Rd SE", from_junction: "J4", to_junction: "J1", lanes: 4, speed_limit: 50, length_km: 1.3 },
  { id: "R7", name: "Moosapet Link", from_junction: "J3", to_junction: "J5", lanes: 2, speed_limit: 30, length_km: 2.1 },
  { id: "R8", name: "Moosapet Link Rev", from_junction: "J5", to_junction: "J3", lanes: 2, speed_limit: 30, length_km: 2.1 },
  { id: "R9", name: "Allwyn Rd", from_junction: "J2", to_junction: "J7", lanes: 3, speed_limit: 40, length_km: 5.0 },
  { id: "R10", name: "Allwyn Rd Rev", from_junction: "J7", to_junction: "J2", lanes: 3, speed_limit: 40, length_km: 5.0 },
  { id: "R11", name: "KPHB-Allwyn Connector", from_junction: "J4", to_junction: "J6", lanes: 3, speed_limit: 40, length_km: 2.0 },
  { id: "R12", name: "KPHB-Allwyn Rev", from_junction: "J6", to_junction: "J4", lanes: 3, speed_limit: 40, length_km: 2.0 },
  { id: "R13", name: "Panjagutta Bypass N", from_junction: "J6", to_junction: "J10", lanes: 4, speed_limit: 60, length_km: 1.5 },
  { id: "R14", name: "Panjagutta Bypass S", from_junction: "J10", to_junction: "J6", lanes: 4, speed_limit: 60, length_km: 1.5 },
  { id: "R15", name: "Hitech City Flyover", from_junction: "J7", to_junction: "J10", lanes: 2, speed_limit: 40, length_km: 6.5 },
  { id: "R16", name: "Hitech City Flyover Rev", from_junction: "J10", to_junction: "J7", lanes: 2, speed_limit: 40, length_km: 6.5 },
  { id: "R17", name: "Bharath Nagar Rd", from_junction: "J5", to_junction: "J8", lanes: 2, speed_limit: 30, length_km: 1.8 },
  { id: "R18", name: "Bharath Nagar Rd Rev", from_junction: "J8", to_junction: "J5", lanes: 2, speed_limit: 30, length_km: 1.8 },
  { id: "R19", name: "MIG Colony Rd", from_junction: "J3", to_junction: "J9", lanes: 2, speed_limit: 30, length_km: 3.8 },
  { id: "R20", name: "MIG Colony Rd Rev", from_junction: "J9", to_junction: "J3", lanes: 2, speed_limit: 30, length_km: 3.8 },
  { id: "R21", name: "Inner Ring Rd", from_junction: "J8", to_junction: "J9", lanes: 2, speed_limit: 25, length_km: 1.2 },
  { id: "R22", name: "Inner Ring Rd Rev", from_junction: "J9", to_junction: "J8", lanes: 2, speed_limit: 25, length_km: 1.2 },
  { id: "R23", name: "NH65 Stretch", from_junction: "J1", to_junction: "J7", lanes: 3, speed_limit: 40, length_km: 5.2 },
  { id: "R24", name: "NH65 Stretch Rev", from_junction: "J7", to_junction: "J1", lanes: 3, speed_limit: 40, length_km: 5.2 },
  { id: "R25", name: "Miyapur Rd", from_junction: "J2", to_junction: "J6", lanes: 4, speed_limit: 60, length_km: 1.6 },
  { id: "R26", name: "Miyapur Rd Rev", from_junction: "J6", to_junction: "J2", lanes: 4, speed_limit: 60, length_km: 1.6 },
  { id: "R27", name: "Pragathi Nagar Rd", from_junction: "J1", to_junction: "J9", lanes: 2, speed_limit: 30, length_km: 1.0 },
  { id: "R28", name: "Pragathi Nagar Rd Rev", from_junction: "J9", to_junction: "J1", lanes: 2, speed_limit: 30, length_km: 1.0 },
  { id: "R29", name: "Nizampet Link", from_junction: "J5", to_junction: "J7", lanes: 2, speed_limit: 35, length_km: 3.0 },
  { id: "R30", name: "Nizampet Link Rev", from_junction: "J7", to_junction: "J5", lanes: 2, speed_limit: 35, length_km: 3.0 },
  { id: "R31", name: "Bachupally Rd", from_junction: "J2", to_junction: "J10", lanes: 3, speed_limit: 40, length_km: 3.0 },
  { id: "R32", name: "Bachupally Rd Rev", from_junction: "J10", to_junction: "J2", lanes: 3, speed_limit: 40, length_km: 3.0 },
  { id: "R33", name: "IDL Rd", from_junction: "J4", to_junction: "J9", lanes: 3, speed_limit: 45, length_km: 2.2 },
];
